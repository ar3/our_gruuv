...
# Run this in production console: Scripts::MigratePersonToTeammate.run

module Scripts
  class MigratePersonToTeammate
    def self.run
        ...
        records_with_person_only.each do |record|
          ...
          begin
            ...
            when 'assignment_check_ins'
              ...
              teammate = Teammate.find_or_create_by(person_id: person_id, organization_id: assignment.company_id) do |t|
            ...
            when 'employment_tenures'
              ...
              teammate = Teammate.find_or_create_by(person_id: person_id, organization_id: employment_tenure.company_id) do |t|
                t.can_manage_employment = false
                t.can_manage_maap = false
                t.can_create_employment = false
              end
            ...
            when 'person_milestones'
              ...
              teammate = Teammate.find_or_create_by(person_id: person_id, organization_id: person_milestone.ability.organization_id) do |t|
                t.can_manage_employment = false
                t.can_manage_maap = false
                t.can_create_employment = false
              end
