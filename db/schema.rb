...
ActiveRecord::Schema[8.0].define(version: 2026_09_09_140000) do
  ...
  create_table "assignment_survey_responses", force: :cascade do |t|
    ...
    t.jsonb "snapshot_outcomes", default: [], null: false
  ...
  create_table "position_suggestion_milestones", force: :cascade do |t|
    ...
    t.index ["processed_by_id"], name: "index_position_suggestion_milestones_on_processed_by_id"
  end
  ...
  create_table "possible_observation_slack_search_batches", force: :cascade do |t|
    ...
    t.integer "position", null: false
    t.jsonb "message_keys", default: [], null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["extraction_status"], name: "idx_on_extraction_status_9b48cbf891"
    t.index ["possible_observation_slack_search_id", "position"], name: "idx_poss_obs_slack_search_batches_on_search_and_position", unique: true
    t.index ["possible_observation_slack_search_id"], name: "idx_poss_obs_slack_search_batches_on_search_id"
  end
  ...
  create_table "title_expectation_alignment_scores", force: :cascade do |t|
    t.bigint "title_id", null: false
    t.bigint "organization_id", null: false
    t.decimal "score", precision: 5, scale: 1
    t.jsonb "cells", default: [], null: false
    t.boolean "path_clarity", default: false, null: false
    t.datetime "calculated_at", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["calculated_at"], name: "index_title_expectation_alignment_scores_on_calculated_at"
    t.index ["organization_id"], name: "index_title_expectation_alignment_scores_on_organization_id"
    t.index ["title_id"], name: "index_title_expectation_alignment_scores_on_title_id", unique: true
  end
  ...
  add_foreign_key "position_suggestion_milestones", "teammates", column: "processed_by_id"
  ...
  add_foreign_key "title_expectation_alignment_scores", "organizations"
  add_foreign_key "title_expectation_alignment_scores", "titles"
