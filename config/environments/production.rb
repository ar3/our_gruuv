...
Rails.application.configure do
  ...
  # Active Storage: S3 (see config/storage.yml `amazon`; bucket from ENV, credentials, or config/active_storage.yml).
  ...
  default_url_options = { 
    ...
    protocol: ENV.fetch('RAILS_ACTION_MAILER_DEFAULT_URL_PROTOCOL', 'https')
  }
