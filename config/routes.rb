Rails.application.routes.draw do
  ...
  resources :organizations do
    ...
    get :teams_health, to: 'organizations/teams_health#index'
    ...
    post :milestones_health_refresh_all, to: 'organizations/milestones_health#refresh_all', as: :milestones_health_refresh_all
    ...
    get :positions_health, to: 'organizations/positions_health#index'
    ...
    resources :bulk_sync_events, only: [:index, :show, :new, :create, :destroy] do
      ...
      member do
        post :process_sync
        post :approve_abilities_hr_ability_group
        post :skip_abilities_hr_ability_group
        post :process_abilities_hr_associations
      end
    end
    ...
    resources :upload_events, only: [:index, :show, :new, :create, :destroy], controller: 'bulk_sync_events' do
      member do
        ...
        post :approve_abilities_hr_ability_group, to: 'bulk_sync_events#approve_abilities_hr_ability_group'
        post :skip_abilities_hr_ability_group, to: 'bulk_sync_events#skip_abilities_hr_ability_group'
        post :process_abilities_hr_associations, to: 'bulk_sync_events#process_abilities_hr_associations'
      end
    end
    ...
    resources :company_teammates, module: :organizations, only: [:show, :update] do
      member do
        ...
        get :position_assignment_ratings_research
    ...
    namespace :insights, module: :organizations do
      ...
      get 'real_og_leaders', to: 'insights#real_og_leaders'
