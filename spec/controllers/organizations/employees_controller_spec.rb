...
RSpec.describe Organizations::EmployeesController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    describe 'legacy check_ins_health spotlight' do
      it 'falls back to teammates_overview stats when spotlight=check_ins_health' do
      ...
      it 'falls back to list view when view=check_ins_health' do
        get :index, params: { organization_id: company.id, view: 'check_ins_health' }
