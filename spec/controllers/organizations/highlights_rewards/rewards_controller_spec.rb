...
RSpec.describe Organizations::HighlightsRewards::RewardsController, type: :controller do
  ...
  let(:reward) { create(:highlights_reward, organization: organization) }
  ...
  describe 'POST #create' do
    ...
    it 'creates a new reward' do
      ...
      }.to change(HighlightsReward, :count).by(1)
    end
    ...
    it 'renders new on failure' do
      post :create, params: { organization_id: organization.id, highlights_reward: { name: '' } }
  ...
  describe 'PATCH #update' do
    ...
    it 'updates the reward' do
      patch :update, params: { organization_id: organization.id, id: reward.id, highlights_reward: { name: 'Updated Name' } }
