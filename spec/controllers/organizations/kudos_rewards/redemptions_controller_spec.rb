...
RSpec.describe Organizations::KudosRewards::RedemptionsController, type: :controller do
  ...
  let(:reward) { create(:kudos_reward, organization: organization, cost_in_points: 50) }
  ...
  describe 'GET #index' do
    context 'as regular user' do
      ...
      it 'shows only own redemptions' do
        own_redemption = create(:kudos_redemption, organization: organization, company_teammate: regular_teammate, kudos_reward: reward)
        other_redemption = create(:kudos_redemption, organization: organization, company_teammate: admin_teammate, kudos_reward: reward)
    ...
    context 'as admin' do
      ...
      it 'shows all redemptions' do
        own_redemption = create(:kudos_redemption, organization: organization, company_teammate: admin_teammate, kudos_reward: reward)
        other_redemption = create(:kudos_redemption, organization: organization, company_teammate: regular_teammate, kudos_reward: reward)
  ...
  describe 'GET #show' do
    context 'viewing own redemption' do
      ...
      let(:redemption) { create(:kudos_redemption, organization: organization, company_teammate: regular_teammate, kudos_reward: reward) }
  ...
  describe 'POST #create' do
    ...
    it 'redirects to redemption show on success' do
      post :create, params: valid_params
      expect(response).to redirect_to(organization_kudos_rewards_redemption_path(organization, KudosRedemption.last))
    end
  ...
  describe 'POST #fulfill' do
    ...
    let(:redemption) { create(:kudos_redemption, :pending, organization: organization, company_teammate: regular_teammate, kudos_reward: reward) }
  ...
  describe 'POST #cancel' do
    ...
    let(:redemption) { create(:kudos_redemption, :pending, organization: organization, company_teammate: regular_teammate, kudos_reward: reward, points_spent: 50) }
