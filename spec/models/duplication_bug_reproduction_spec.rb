...
RSpec.describe 'Duplication Bug Reproduction', type: :model do
  ...
  describe 'Old MaapSnapshot.build_for_employee_with_changes method' do
    context 'when form params cause cross-assignment duplication like in snapshot 108' do
      it 'should fail by reproducing the buggy behavior from snapshot 108' do
        ...
        # Create MAAP snapshot using the OLD method
        snapshot = MaapSnapshot.build_for_employee_with_changes(
          employee: employee,
          created_by: employee,
          change_type: 'bulk_check_in_finalization',
          reason: 'Testing snapshot 108 duplication bug with OLD method',
        ...
        puts "OLD METHOD - Assignment 1 (ID: #{assignment1.id}, Title: #{assignment1.title}):"
        ...
        puts "OLD METHOD - Assignment 2 (ID: #{assignment2.id}, Title: #{assignment2.title}):"
        ...
        puts "OLD METHOD - Assignment 3 (ID: #{assignment3.id}, Title: #{assignment3.title}):"
