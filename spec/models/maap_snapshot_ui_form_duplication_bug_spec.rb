...
RSpec.describe MaapSnapshot, type: :model do
  ...
  describe 'build_official_check_in_data_with_changes' do
    context 'when form params are processed in the wrong order causing cross-assignment duplication' do
      it 'should fail by producing the buggy behavior from the UI scenario' do
        ...
        # The key insight: the form params might be processed in a way that causes
        # assignment 1 to get assignment 3's values, and assignment 2 to get assignment 1's values
        
        # Form params as they would come from the UI
        form_params = {
        ...
        snapshot = MaapSnapshot.build_for_employee_with_changes(
          ...
          reason: 'Testing UI form duplication bug scenario',
