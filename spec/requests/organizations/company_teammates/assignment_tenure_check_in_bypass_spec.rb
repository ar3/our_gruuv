  ...
  describe 'GET /organizations/:organization_id/company_teammates/:id/assignment_tenure_check_in_bypass' do
    context 'when user is a manager' do
      ...
      it 'shows assignment energy allocation bars with page and section help' do
        ...
        expect(response.body).to include('setDayToDayAssignmentsPageHelp')
        expect(response.body).to include('Set Day-to-Day Assignments')
        expect(response.body).to include('This page bypasses, but still works well with, the normal check-in flow')
        expect(response.body).to include('Set Assignments')
