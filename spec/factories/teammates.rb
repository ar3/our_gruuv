FactoryBot.define do
  factory :company_teammate, class: 'CompanyTeammate' do
    association :person
  ...
  # Alias for backward compatibility in specs
  factory :teammate, parent: :company_teammate, class: 'CompanyTeammate'
end
