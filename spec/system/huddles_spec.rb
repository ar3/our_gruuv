...
RSpec.describe 'Huddles', type: :system, critical: true do
  ...
  it 'visiting the huddles index' do
    visit huddles_path
  ...
  it 'index shows only active huddles' do
  ...
  it 'viewing my huddles when logged in' do
  ...
  it 'viewing my huddles when not logged in redirects to huddles' do
    visit my_huddles_path
  ...
  it 'viewing huddle summary as participant' do
  ...
  it 'viewing huddle summary when not logged in redirects to join' do
    visit huddle_path(huddle)
  ...
  it 'viewing huddle summary when not a participant redirects to join' do
  ...
  it 'huddle summary shows insights and participation data' do
  ...
  it 'creating a new huddle when not logged in' do
  ...
  it 'creating a new huddle when already logged in' do
  ...
  it 'joining an existing huddle when not logged in' do
  ...
  it 'joining an existing huddle when already logged in' do
    person = Person.create!(full_name: 'Bob Wilson', email: 'bob@example.com')
  ...
  it 'updating role when already a participant' do
    person = Person.create!(full_name: 'Alice Johnson', email: 'alice@example.com')
    teammate = Teammate.create!(person: person, organization: team)
  ...
  it 'submitting feedback when not logged in' do
  ...
  it 'submitting feedback when logged in' do
    person = Person.create!(full_name: 'Charlie Brown', email: 'charlie@example.com')
    teammate = Teammate.create!(person: person, organization: team)
    huddle.huddle_participants.create!(teammate: teammate, role: 'active')
  ...
  it 'huddle display shows correct information' do
  ...
  it 'allows multiple huddles for same organization' do
    # Create a huddle for today
  ...
  it 'updates existing person name when joining with different name' do
  ...
  it 'preserves existing person name when creating huddle' do
    # Create a person with initial name
    existing_person = Person.create!(
