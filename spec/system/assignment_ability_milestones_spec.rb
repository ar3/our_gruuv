...
RSpec.describe 'Assignment Ability Milestones', type: :system, critical: true do
  ...
  describe 'Assignment-centric milestone management' do
    ...
    it 'creates new milestone associations' do
      ...
      expect(page).to have_content('Ability milestone associations were successfully updated')
