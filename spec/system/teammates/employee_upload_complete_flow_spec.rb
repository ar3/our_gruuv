...
RSpec.describe 'Employee Upload Complete Flow', type: :system do
  ...
  describe 'Complete employee upload flow scenarios' do
    ...
    it 'creates employee upload with minimal required fields only' do
      ...
      expect(page).to have_content(/Processing|Results|successful|completed/i, wait: 10)
      
      # Step 5: Verify minimal data creation - wait a bit for DB to update
      sleep 0.5
