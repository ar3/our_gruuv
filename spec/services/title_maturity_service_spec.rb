...
RSpec.describe TitleMaturityService, type: :service do
  ...
  describe '.calculate_phase' do
    it 'returns 1 when no positions have assignments' do
      ...
      expect(described_class.calculate_phase(title)).to eq(1)
    end
    ...
    context 'Phase 1' do
      it 'returns 2 when at least one position has a required assignment but not all positions have required assignments' do
        ...
        position2 = create(:position, title: title, position_level: create(:position_level, position_major_level: position_major_level))
        ...
        expect(described_class.calculate_phase(title)).to eq(2)
      end
    end
    ...
    context 'Phase 2' do
      it 'returns 3 when all positions have required assignments' do
        ...
        expect(described_class.calculate_phase(title)).to eq(3)
      end
    ...
    context 'Phase 3' do
      it 'returns 4 when employees have check-ins on required assignments' do
        ...
        expect(described_class.calculate_phase(title)).to eq(4)
      end
    ...
    context 'Phase 4' do
      it 'returns 5 when all required assignments have ability requirements' do
        ...
        expect(described_class.calculate_phase(title)).to eq(5)
      end
    ...
    context 'Phase 5' do
      it 'returns 6 when all abilities have at least 2 milestones defined' do
        ...
        expect(described_class.calculate_phase(title)).to eq(6)
      end
    ...
    context 'Phase 6' do
      it 'returns 7 when all abilities have milestone attainments' do
        ...
        expect(described_class.calculate_phase(title)).to eq(7)
      end
    ...
    context 'Phase 8' do
      xit 'returns 9 when ≥5% of entities updated in last 6 months' do
        ...
        expect(described_class.calculate_phase(title)).to eq(9)
      end
  ...
  describe '.next_steps_message' do
    it 'returns message for phase 1' do
      create(:position, title: title, position_level: position_level)
      message = described_class.next_steps_message(title)
  ...
  describe '.phase_status' do
    it 'returns array of 9 booleans' do
      status = described_class.phase_status(title)
