module CheckInHelper
  ...
  # Sentence describing energy for an assignment check-in.
  def assignment_energy_sentence(check_in)
    ...
    sentence << "they spent about <strong>#{h(energy)}</strong>% of their energy on this assignment."
    sentence.html_safe
  end
