# app/services/highlights/award_celebratory_points_service.rb
...
class Highlights::AwardCelebratoryPointsService
  def self.call(...) = new(...).call

  # Default point configurations for each moment type
  # Organizations can override these in their highlights_celebratory_config
  DEFAULT_CONFIGS = {
  ...
  def points_config
    ...
    org_config = @organization.highlights_celebratory_points_for(moment_type)
