  ...
  class ObserveBirthdaysService
    ...
    def call
      ...
      candidates.each do |teammate|
        ...
        birthday_date = birthday_date_in_window(teammate.person, range_start, range_end)
        next unless birthday_date
        ...
        result = BaseObservableMomentService.call(
          ...
          occurred_at: birthday_date.to_time,
          metadata: { birthday_date: birthday_date.iso8601 }
        )
    ...
    def birthday_date_in_window(person, range_start, range_end)
      return nil unless person.born_at.present?

      month = person.born_at.month
      day = person.born_at.day
