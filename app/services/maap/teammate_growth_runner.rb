...
module Maap
  class TeammateGrowthRunner
    def self.call(teammate:, organization:, og_consultation:)
      new(teammate: teammate, organization: organization, og_consultation: og_consultation).call
    end

    def initialize(teammate:, organization:, og_consultation:)
      @teammate = teammate
    ...
    def call
      ...
      llm = Llm::Client.call(
        purpose: 'teammate_growth',
        model_id: model_id,
        system_instructions: Maap::Prompts::TEAMMATE_GROWTH_AGENT,
      ...
      result = @consultation.result || @consultation.create_teammate_growth_result!
