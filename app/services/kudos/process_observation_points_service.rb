# app/services/kudos/process_observation_points_service.rb
# Service for processing kudos points when an observation is published
# Awards points to observees and kickback rewards to observers
class Kudos::ProcessObservationPointsService
