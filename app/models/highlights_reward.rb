# Represents a reward item that can be redeemed with highlights points
# Examples: gift cards, company swag, experiences, etc.
class HighlightsReward < ApplicationRecord
  belongs_to :organization
  has_many :highlights_redemptions, dependent: :restrict_with_error
