class HighlightsTransaction < ApplicationRecord
  ...
  belongs_to :highlights_redemption, optional: true
  belongs_to :company_teammate_banker, class_name: 'CompanyTeammate', optional: true
  belongs_to :triggering_transaction, class_name: 'HighlightsTransaction', optional: true

  has_many :triggered_transactions, class_name: 'HighlightsTransaction', foreign_key: :triggering_transaction_id
  ...
  def apply_to_ledger!
    ledger = HighlightsPointsLedger.find_or_create_for(company_teammate, organization)
