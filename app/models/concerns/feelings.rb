module Feelings
  FEELINGS = [
    ...
    { display: '🛡️ (Safe)', discrete_feeling: :safe, base_feeling: :happy, display_grouping: :happy, positive_negative_or_neutral: :positive },
    ...
    { display: '🌱 (Hopeful)', discrete_feeling: :hopeful, base_feeling: :happy, display_grouping: :happy, positive_negative_or_neutral: :positive },
    ...
    { display: '😇 (Grateful)', discrete_feeling: :grateful, base_feeling: :happy, display_grouping: :happy, positive_negative_or_neutral: :positive },
    ...
    { display: '⏳ (Uncertain)', discrete_feeling: :uncertain, base_feeling: :surprised, display_grouping: :surprised, positive_negative_or_neutral: :neutral },
    { display: '🌀 (Mixed)', discrete_feeling: :mixed, base_feeling: :meh, display_grouping: :meh, positive_negative_or_neutral: :neutral },
    { display: '🧩 (Processing)', discrete_feeling: :processing, base_feeling: :surprised, display_grouping: :surprised, positive_negative_or_neutral: :neutral },
    ...
    { display: '😞 (Discouraged)', discrete_feeling: :discouraged, base_feeling: :sad, display_grouping: :bad, positive_negative_or_neutral: :negative },
    { display: '🫥 (Disconnected)', discrete_feeling: :disconnected, base_feeling: :sad, display_grouping: :bad, positive_negative_or_neutral: :negative },
    { display: '😣 (Pressured)', discrete_feeling: :pressured, base_feeling: :bad, display_grouping: :bad, positive_negative_or_neutral: :negative },
    { display: '😔 (Hurt)', discrete_feeling: :hurt, base_feeling: :sad, display_grouping: :bad, positive_negative_or_neutral: :negative },
    { display: '🧊 (Guarded)', discrete_feeling: :guarded, base_feeling: :fearful, display_grouping: :fearful, positive_negative_or_neutral: :negative },
    ...
    { display: '😒 (Concerned)', discrete_feeling: :concerned, base_feeling: :disgusted, display_grouping: :bad, positive_negative_or_neutral: :negative },
