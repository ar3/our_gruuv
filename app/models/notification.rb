class Notification < ApplicationRecord
  ...
  scope :goals_health_nudges, -> { where(notification_type: 'goals_health_nudge') }
  scope :health_nudges, -> { where(notification_type: 'health_nudge') }
