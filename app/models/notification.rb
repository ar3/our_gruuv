class Notification < ApplicationRecord
  ...
  validates :notification_type, inclusion: { in: %w[huddle_announcement huddle_summary huddle_feedback observation_dm observation_channel comment_channel test], allow_nil: true }
