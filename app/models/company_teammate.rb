class CompanyTeammate < ApplicationRecord
  ...
  has_many :talent_density_stances, foreign_key: :company_teammate_id, dependent: :destroy
  ...
  has_many :assignment_survey_responses, foreign_key: :teammate_id, dependent: :destroy
