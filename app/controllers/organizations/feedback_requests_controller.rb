class Organizations::FeedbackRequestsController < Organizations::OrganizationNamespaceBaseController
  ...
  def select_focus
    ...
    @abilities = Ability.where(id: ability_ids.to_a, organization: company.self_and_descendants).order(:name)
    ...
    @aspirations = Aspiration.where(organization_id: aspiration_org_ids).ordered
  ...
  def update_focus
    ...
    ability_attrs = Ability.where(id: ability_ids, organization: company.self_and_descendants).map { |a| { rateable_type: 'Ability', rateable_id: a.id } }
    aspiration_attrs = Aspiration.where(id: aspiration_ids, organization: company.self_and_descendants).map { |a| { rateable_type: 'Aspiration', rateable_id: a.id } }
