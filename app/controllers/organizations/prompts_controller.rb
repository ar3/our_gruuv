class Organizations::PromptsController < Organizations::OrganizationNamespaceBaseController
  ...
  def edit
    ...
    hierarchy = Goals::LinkedGoalsHierarchyLoader.call(goal_ids: goal_ids)
    @linked_goals = hierarchy[:linked_goals]
    @linked_goal_check_ins = hierarchy[:linked_goal_check_ins]
  ...
  def update
    ...
    @prompt_goals = @prompt.prompt_goals.includes(:goal).to_a
    hierarchy = Goals::LinkedGoalsHierarchyLoader.call(goal_ids: @prompt.goals.pluck(:id))
    @linked_goals = hierarchy[:linked_goals]
    @linked_goal_check_ins = hierarchy[:linked_goal_check_ins]
