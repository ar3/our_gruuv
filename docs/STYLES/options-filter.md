...
- **Manage assignment reliance (Add section):** `/organizations/:org/assignments/:id/consumer_assignments` — filters available assignments with upstream/downstream association radios (title-pathing style).
